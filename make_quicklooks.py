...
def plot_quicklooks(fname,fig_dir,fig_name):
    ...
    axs[0].set_title(fig_name) #ds.time[0].values.astype('datetime64[D]'))
    fig.tight_layout()
...
if __name__=='__main__':
    ...
    plot_quicklooks(args.l2a_file, args.fig_dir, fig_name)
